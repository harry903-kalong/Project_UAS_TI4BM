...
public class Products {
    ...
    public Products(JSONObject json) {
        ...
        this.unitsInStock = (short) json.optInt("unitsInStock", 0);
        this.unitsOnOrder = (short) json.optInt("unitsOnOrder", 0);
        this.reorderLevel = (short) json.optInt("reorderLevel", 0);
